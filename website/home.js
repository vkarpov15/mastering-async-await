...
const cyberWeekSaleBuyButton = `
<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="M5LHYE36MNAYG">
...
<del>&nbsp;$24.99&nbsp;</del>
$19.99<br>
<small>Cyber Week Sale ends Nov 30!</small>
`;

module.exports = ({ price = salePrice, buyButton = cyberWeekSaleBuyButton }) => `
<div class="left">
